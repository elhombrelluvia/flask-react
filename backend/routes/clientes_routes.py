...
clientes_bp.route("/activos", methods=["GET"])(obtener_clientes_activos)
...
clientes_bp.route("/<cliente_id>", methods=["PUT"])(actualizar_cliente)
clientes_bp.route("/<cliente_id>", methods=["DELETE"])(eliminar_cliente)